...
insert  into `t_montir`(`id_montir`,`nama_montir`,`hargaperjam`) values ('M-01','jono',30000);
...
insert  into `t_service`(`id_service`,`tgl_service`,`id_user`,`id_montir`,`id_sparepart`,`jumlah_sparepart`,`total_service`) values ('S-01','2020-05-12','A-2','M-01','O-01',5,0);
...
insert  into `t_sparepart`(`id_sparepart`,`nama_sparepart`,`harga_sparepart`,`satuan`) values ('O-01','OLI',2000,20);
...
insert  into `t_user`(`id_user`,`nama_user`,`email`,`password`,`id_level`) values ('A-1','alfida','alfida@mail.com','d32b7e3369d2053cf393693e800f879a',2),('A-2','dan','dan@mail.com','9180b4da3f0c7e80975fad685f7f134e',2),('A-3','bbb','bbb@mail.com','08f8e0260c64418510cefb2b06eee5cd',2),('A-4','xxx','xxx@mail.com','08f8e0260c64418510cefb2b06eee5cd',2),('U-01','Kusuma','mail@mail.com','ef86916bc6f9f2f6866df100a192161f',1),('U-02','Dani','kusuma@mail.com','ef86916bc6f9f2f6866df100a192161f',2),('U-06','KAKA','kaka@mail.com','5541c7b5a06c39b267a5efae6628e003',1),('U-1000','Dani','danikusuma@mail.com','ab5e831d8600f15167307bd73177b525',1),('U-111','kakao','kakao@mail.com','d42de1f57e8dd01202d9c36d807fb157',2),('U-18','aaa','aaa@mail.com','47bce5c74f589f4867dbd57e9ca9f808',2),('U-90','sss','sss@mail.com','9f6e6800cfae7749eb6c486619254b9c',2);
